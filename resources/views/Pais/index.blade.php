...
<div class="card">
      <div class="container">
        <br>
        <h2 style="color:green;text-align: center;">Pais</h2>
        <div class="card-header" style="text-align: left;"><a href="{{route('pais.create')}}" type="button" class="btn btn-info mb-3" style=" cursor: grab;border-radius: 5px; border: 1px green solid;">Agregar Pais</a>
          ...
          <tbody>  
            ...
            <tr>
              ...
              <td>
                ...
                <!--EDITAR-->
                <a title="Edit Image" href="{{ route('pais.edit',$pai->id ) }}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                <!--DELETE-->
